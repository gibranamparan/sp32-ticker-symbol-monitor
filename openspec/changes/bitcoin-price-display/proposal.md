...
### New Capabilities
- `price-fetching`: Connecting to WiFi and retrieving the BTC-USD spot price from Coinbase over HTTPS, with parsing, error handling, and the 10-second refresh cadence.
